...
am4internal_webpackJsonp(["3cd8"], {
    vlr4: function (t, e, i) {
            ...
            h = function (t) {
                ...
                return Object(o.c)(e, t), e.prototype.createDataItem = function () {
                    ...
                    var a = this.yAxis.renderer,
                        ...
                        l = this.xAxis.getX(t, e, n, s),
                        h = this.xAxis.getY(t, e, n, s),
                    ...
                    var t = this.xAxis.renderer,
                        e = this.yAxis.renderer;
            ...
            m = function (t) {
                function e() {
                    ...
                    return e.pixelRadiusReal = 0, e.autoScaleScale = 1, e.layout = "none", e.autoScale = !0, e.autoCenter = !0, e.isMeasured = !1, e.className = "AxisRendererCurveX", e.line.strokeOpacity = 1, e.precisionStep = 10, e.points = [{
                        ...
                        x: 300,
                        y: 0
                    }], e._tempSprite = e.createChild(p.a), e._tempSprite.visible = !1, e.applyTheme(), e
                }
                return Object(o.c)(e, t), Object.defineProperty(e.prototype, "axisLength", {
                    ...
                    if (this.points) {
                        var e = this.axis.chart,
                            ...
                            s = this._tempSprite.element.getBBox(),
                            r = {
                                x: 0,
                                y: 0
                            };
                    ...
                    var e = this.positionToPoint(t),
                        i = e.angle,
                        n = this.axisRendererY;
                    if (n) {
                        var o = -n.radius,
                            s = -n.innerRadius;
                        return f.moveTo({
                    ...
                    if (n) {
                        ...
                        if (e == t) return i;
                        var l = 0 | u.round(n.positionToPoint(s).y, 1),
                            h = 0 | u.round(n.positionToPoint(r).y, 1),
                            c = this.positionToPoint(t),
                            d = c.angle;
                        i = f.moveTo(c);
                    ...
                    return i
                }, e.prototype.updateBaseGridElement = function () {}, e.prototype.updateBullet = function (t, e, i) {
                    var n = .5;
                    ...
                    if (e) {
                        var i = t.startPosition,
                            n = t.endPosition,
                            o = this.positionToAngle(i),
                            s = this.positionToPoint(i),
                            r = this.positionToAngle(n),
                            a = this.positionToPoint(n),
                            p = t.startLine,
                            l = t.endLine,
                            h = t.fillShape,
                            c = -e.radius + t.pixelMarginTop,
                            d = -e.innerRadius - t.pixelMarginBottom,
                            y = {
                                x: s.x + d * u.cos(o),
                                y: s.y + d * u.sin(o)
                            },
                        ...
                        for (var b = this.axis.start, C = this.axis.end, A = Math.ceil(this.axisLength / this.precisionStep * (n - i) / (C - b)), T = 0; T <= A; T++) {
                            var R = i + T / A * (n - i),
                                S = (L = this.positionToPoint(R)).angle,
                                O = L.x + c * u.cos(S),
                                V = L.y + c * u.sin(S);
                            m += f.lineTo({
                                x: O,
                    ...
                    var n = this.polyspline.allPoints,
                        o = this.polyspline.getClosestPointIndex({
                            x: e,
                            y: i
                        });
                    return t.prototype.coordinateToPosition.call(this, o / (n.length - 1) * this.axisLength)
                }, e.prototype.updateTooltip = function () {}, Object.defineProperty(e.prototype, "inversed", {
                    get: function () {
                        return !1
                    },
                    set: function (t) {},
        ...
        var b = i("OXm9"),
            ...
            T = function (t) {
                ...
                return Object(o.c)(e, t), e.prototype.validate = function () {
                    ...
                    if (t) {
                        var e = t.axis,
                            i = t.positionToPoint(e.start + (e.end - e.start) * this.axisLocation),
                            n = i.angle,
                            o = -this.radius,
                            s = -this.innerRadius;
                        this.line.path = f.moveTo({
                            x: s * u.cos(n),
                            y: s * u.sin(n)
                        }) + f.lineTo({
                            x: o * u.cos(n),
                    ...
                    x.hasValue(n) || (n = t.location), e += (i - e) * n;
                    var o = this.positionToPoint(e).y,
                        s = this.axisRendererX;
                    if (s) {
                        var r = s.axis,
                            a = s.positionToPoint(r.start + (r.end - r.start) * this.axisLocation),
                            p = a.angle;
                    ...
                    if (o) {
                        var s = o.positionToPoint(this.axisLocation),
                            r = s.angle,
                            a = this.positionToPoint(e).y;
                    ...
                    if (n) {
                        ...
                        var p = u.round(this.positionToPoint(t).y, 1),
                            l = u.round(this.positionToPoint(e).y, 1);
                        if (x.isNaN(p) || x.isNaN(l)) return "";
                        var h = n.positionToPoint(o),
                            c = h.angle;
                        i = f.moveTo(h);
                    ...
                    var n = this.axisRendererX,
                        o = e;
                    if (n) {
                        var s = n.polyspline.allPoints[n.polyspline.getClosestPointIndex({
                                x: i,
                                y: e
                            })],
                            r = s.angle - 90;
        ...
        var R = i("Q4nc"),
            ...
            O = function (t) {
                ...
                return Object(o.c)(e, t), e.prototype.applyInternalDefaults = function () {
                    ...
                    if (e && (x.hasValue(e.cursor) && !x.hasValue(e.cursor.type) && (e.cursor.type = "CurveCursor"), x.hasValue(e.series) && x.isArray(e.series)))
                        for (var i = 0, n = e.series.length; i < n; i++) e.series[i].type = e.series[i].type || "CurveLineSeries";
                    ...
                    for (var e = 0; e < R.a.licenses.length; e++)
                        if (R.a.licenses[e].match(/^TL.{5,}/i)) return !0;
                    return !1
                }, e
            }(s.a);
        ...
        var V = i("tjMS"),
            ...
            I = function (t) {
                ...
                return Object(o.c)(e, t), Object.defineProperty(e.prototype, "orientation", {
                    ...
                    var e = this.curveContainer,
                        i = this.plotContainer.maxWidth - e.pixelPaddingLeft - e.pixelPaddingRight,
                        n = this.plotContainer.maxHeight - e.pixelPaddingTop - e.pixelPaddingBottom,
                        o = 0;
                    ...
                    if ("vertical" == this.orientation) {
                        ...
                        for (var p = 0; p < this.levelCount; p++)
                            if (p % 2 == 0) {
                                r.push({
                                    x: -i / 2 + s,
                                    y: -n / 2 + n / (a - 1) * p
            ...
            Y = function (t) {
                ...
                return Object(o.c)(e, t), Object.defineProperty(e.prototype, "levelCount", {
                    ...
                    var e = this.curveContainer,
                        ...
                        o = u.min(i, n) / 2,
                        s = this.radiusStep,
                        r = L.relativeRadiusToValue(this.innerRadius, o);
        ...
        var M = i("5vid"),
            k = function (t) {
                ...
                return Object(o.c)(e, t), e.prototype.createAssets = function () {
                    this.CurveColumn = this.createChild(p.a), this.CurveColumn.shouldClone = !1, this.CurveColumn.strokeOpacity = void 0, this.column = this.CurveColumn
                }, e.prototype.copyFrom = function (e) {
                    t.prototype.copyFrom.call(this, e), this.CurveColumn && this.CurveColumn.copyFrom(e.CurveColumn)
                }, e
            }(i("DG6Q").a);
        a.c.registeredClasses.CurveColumn = k;
        var w = i("pR7v"),
            _ = i("VB2N"),
            N = function (t) {
                function e() {
            ...
            D = function (t) {
                ...
                return Object(o.c)(e, t), e.prototype.createColumnTemplate = function () {
                    ...
                    var e = this,
                        ...
                        a = this.getEndLocation(t),
                        p = this.columns.template,
                        l = p.percentWidth,
                        h = p.percentHeight;
                    x.isNaN(l) && (l = 100);
                    var c, d = [],
                    ...
                    if (this.baseAxis == this.xAxis) {
                        r += R = u.round((a - r) * (1 - l / 100) / 2, 5);
                        var m = ((a -= R) - r) / (Math.ceil(this.xAxis.axisLength / P.precisionStep / (this.endIndex - this.startIndex)) + 2),
                            b = t.locations[n],
                            C = t.locations[i];
                        if (this.yAxis instanceof w.a) this.dataFields[this.yField] != this.dataFields[this.yOpenField] && (b = 0, C = 0);
                        else if (this.yAxis instanceof _.a && !x.isNaN(h)) {
                            C = 0, b = 1;
                            var A = u.round((1 - h / 100) / 2, 5);
                            C += A, b -= A
                        }
                        for (var T = r; T <= a; T += m) T > a && (T = a), d.push(this.getPoint(t, o, i, T, C));
                        d.push(this.getPoint(t, o, i, a, C));
                        for (T = a; T >= r; T -= m) T < r && (T = r), d.push(this.getPoint(t, s, n, T, b));
                        d.push(this.getPoint(t, s, n, r, b)), c = this.getPoint(t, o, i, r + (a - r) / 2, .5)
                    } else {
                        var R;
                        r += R = u.round((a - r) * (1 - h / 100) / 2, 5), a -= R;
                        var S = {
                                start: y.start,
                                end: y.end
                            },
                            ...
                            V = t.locations[o],
                            L = t.locations[s];
                        this.xAxis instanceof w.a && this.dataFields[this.xField] != this.dataFields[this.xOpenField] && (V = 0, L = 0);
                        var j = y.getPositionX(t, s, L, "valueX", S),
                            I = y.getPositionX(t, o, V, "valueX", S),
                            X = v.getPositionY(t, n, r, "valueY", O),
                            Y = v.getPositionY(t, i, a, "valueY", O);
                        m = (I - j) / (Math.ceil(y.axisLength / P.precisionStep * (I - j) / (y.end - y.start)) + 2);
                        if (I > j) {
                            for (T = j; T <= I; T += m) T > I && (T = I), d.push(y.renderer.positionToPoint(T, X));
                            d.push(y.renderer.positionToPoint(I, X));
                            for (T = I; T >= j; T -= m) T < j && (T = j), d.push(y.renderer.positionToPoint(T, Y));
                            d.push(y.renderer.positionToPoint(j, Y))
                        }
                        c = y.renderer.positionToPoint(j + (I - j) / 2, X + (Y - X) / 2)
                    }
                    var M = t.column;
                    M || (M = this.columns.create(), t.column = M, t.addSprite(M), this.setColumnStates(M), M.paper = this.paper);
                    var k = M.CurveColumn;
                    d.length > 0 && d.push(d[0]), k.path = f.pointsToPath(d), M.__disabled = !1, M.parent = this.columnsContainer, M.tooltipX = c.x, M.tooltipY = c.y, M.CurveColumn.tooltipX = c.x, M.CurveColumn.tooltipY = c.y, this.axisRanges.each(function (i) {
                        var n = t.rangesColumns.getKey(i.uid);
                        n || ((n = e.columns.create()).dataItem && g.remove(n.dataItem.sprites, n), t.addSprite(n), n.paper = e.paper, e.setColumnStates(n), t.rangesColumns.setKey(i.uid, n)), n.CurveColumn.path = k.path, n.__disabled = !1, n.parent = i.contents
                    })
                }, e.prototype.getPoint = function (t, e, i, n, o, s, r) {
                    s || (s = "valueX"), r || (r = "valueY");
                    var a = this.yAxis.renderer,
                        ...
                        h = this.xAxis.getX(t, e, n, s, l),
                        c = this.xAxis.getY(t, e, n, s, l),
                        d = this.xAxis.getAngle(t, e, n, s, l);
                    return {
                        x: h + p * u.cos(d),
                        y: c + p * u.sin(d)
                    }
                    ...
                    var t = this.yAxis.renderer,
                        e = t.getPositionRangePath(t.axis.start, t.axis.end),
        ...
        a.c.registeredClasses.CurveColumnSeries = D, a.c.registeredClasses.CurveColumnSeriesDataItem = N;
        var B = i("KknQ"),
            E = function (t) {
                function e() {
                    var e = t.call(this) || this;
                ...
                return Object(o.c)(e, t), e.prototype.createDataItem = function () {
                    ...
                    if (this.baseAxis == this.xAxis) {
                        var d = Math.ceil(this.xAxis.axisLength / c.precisionStep / (this.endIndex - this.startIndex)) + 2,
                            y = Math.abs(r - s) / d;
                        if (this.xAxis instanceof B.a) {
                            var f = e.index;
                            if (o) {
                                var g = this.dataItems.getIndex(f - 1),
                                    v = this.xAxis.baseDuration;
                        ...
                        var C = a.getPositionX(e, i, e.locations[i], "valueX", l),
                            A = p.getPositionY(e, n, s, "valueY", h);
                        if (x.isNumber(u)) {
                            d = Math.ceil(a.axisLength / c.precisionStep * (C - u) / (a.end - a.start)) + 2, y = Math.abs((C - u) / d);
                            if (C > u)
                                for (b = u; b <= C; b += y) b > C && (b = C), t.push(a.renderer.positionToPoint(b, A));
                            else if (C < u)
                                for (b = u; b >= C; b -= y) b < C && (b = C), t.push(a.renderer.positionToPoint(b, A))
                        }
        ...
        a.c.registeredClasses.CurveStepLineSeries = F, a.c.registeredClasses.CurveStepLineSeriesDataItem = E;
        var G = function (t) {
            function e() {
                var e = t.call(this) || this;
            ...
            return Object(o.c)(e, t), e.prototype.fitsToBounds = function (t) {
                if (this.xAxis && this.yAxis) {
                    var e = this.xAxis.renderer,
                        i = this.yAxis.renderer,
                        n = e.polyspline.getClosestPointIndex(t),
                ...
                if (i || (this.xAxis = this.chart.xAxes.getIndex(0), i = this.xAxis), e && e.visible && !e.disabled && i) {
                    var n = i.renderer.pointToPosition(t),
                        o = i.renderer;
                ...
                if (this._usesSelection) {
                    ...
                    if (e && i && t) {
                        ...
                        if ("zoomX" == r || "selectX" == r) {
                            var a = e.renderer.pointToPosition(t),
                                p = e.renderer.pointToPosition(n);
                ...
                if (this.xAxis.cursorTooltipEnabled) {
                    ...
                    this.updateLineX(L.svgPointToSprite({
                        x: e.pixelX,
                        y: e.pixelY
                    }, this))
                }
                ...
                if (this.yAxis.cursorTooltipEnabled) {
                    ...
                    this.updateLineY(L.svgPointToSprite({
                        x: e.pixelX,
                        y: e.pixelY
                    }, this))
                }
            }, e.prototype.updateLinePositions = function (t) {}, e.prototype.getRanges = function () {}, e.prototype.updateSize = function () {}, e.prototype.fixPoint = function (t) {
                return t
            }, e
        }(i("gqvf").a);
        a.c.registeredClasses.CurveCursor = G, window.am4plugins_timeline = n
    }
}, ["vlr4"]);
